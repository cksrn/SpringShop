		...
		<ul>
			...
			<li>
				<div class="replyInfo">
					...
					<p>
						<span>작성한 상품</span><a href="/shop/view?n=${reply.gdsNum}">바로가기</a>
					</p>
				</div>
				...
				<div class="replyController">
					<form role="form" method="post">
						<input type="hidden" name="comNum" value="${reply.comNum}" />
						<button type="submit" class="delete_${reply.comNum}_btn">삭제</button>
					</form>
				</div>
			</li>
