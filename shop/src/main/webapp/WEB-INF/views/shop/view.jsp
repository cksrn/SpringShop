	...
	$.getJSON("/shop/view/replyList" + "?n=" + gdsNum,function(data){
		...
		$(data).each(function(){
			...
			/*			
				...
				+ "</div>"
				+ "<div class='replyContent'>" + this.comCon + "</div>"
				+ "</li>"; 
				*/			
			str += "<li data-comNum='" + this.comNum + "'>"
		     + "<div class='userInfo'>"
		     + "<span class='userName'>" + this.userName + "</span>"
		     + "<span class='date'>" + comDate + "</span>"
		     + "</div>"
		     ...
		     + "<button type='button' class='modify' data-comNum='" + this.comNum + "'>수정</button>"
		     + "<button type='button' class='delete' data-comNum='" + this.comNum + "'>삭제</button>"
		     + "</div>"
				...
				<section id="content">
					...
					<div id="reply">
						<c:if test="${member == null }">
							<p>소감을 남기시려면<a href="/member/signin">로그인</a>필요</p>
						</c:if>
						...
						<section class="replyList">
							...
							<script>
								$(document).on("click",".delete",function(){
									...
									if(deleteConfirm){
									var data = {comNum : $(this).attr("data-comNum")};
...
<script>
	$(document).on("click",".modify",function(){
		...
		var comNum = $(this).attr("data-comNum");
		var comCon = $(this).parent().parent().children(".replyContent").text();
		
		$(".modal_comCon").val(comCon);
		$(".modal_modify_btn").attr("data-comNum",comNum);
	});
</script>
<script>
$(".modal_modify_btn").click(function(){
	 ...
	 if(modifyConfirm) {
	  var data = {
	     comNum : $(this).attr("data-comNum"),
	     comCon : $(".modal_comCon").val()
	    };  // ReplyVO 형태로 데이터 생성
